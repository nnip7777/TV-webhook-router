...
class AlorClient:
    ...
    async def get_access_token(self) -> str:
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            raise Exception(f"Alor auth failed: {resp.status_code}")
    ...
    async def get_orderbook(self, exchange: str, symbol: str, depth: int = 20) -> Dict:
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            if resp.status_code == 200:
                return resp.json()
            raise Exception(f"Orderbook failed: {resp.status_code}")
    ...
    async def place_market_order(self, symbol: str, exchange: str, side: str,
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            if resp.status_code == 200:
                return resp.json()
            raise Exception(f"Market order failed: {resp.status_code}")
...
class FinamClient:
    ...
    async def get_jwt_token(self) -> str:
        ...
        async with httpx.AsyncClient(http2=True, timeout=30) as client:
            ...
            raise Exception(f"Finam auth failed: {resp.status_code} - {resp.text[:200]}")
    ...
    async def get_account(self) -> Dict:
        ...
        async with httpx.AsyncClient(http2=True, timeout=30) as client:
            ...
            if resp.status_code == 200:
                return resp.json()
            raise Exception(f"Account failed: {resp.status_code}")
    ...
    async def place_order(self, symbol: str, board: str, side: str,
        ...
        body = {
            "securityBoard": board,
            "securityCode": symbol,
            "buySell": side,  # "SIDE_BUY" или "SIDE_SELL"
