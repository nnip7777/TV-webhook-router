...
<div class='panel'><h3 style='margin-top:0;'>Последние fills</h3><div id='fills'></div></div>
...
async function load(){
  ...
  try{
    ...
    document.getElementById('fills').innerHTML=renderTable([
      {key:'observed_at',label:'time'}, {key:'broker',label:'broker'}, {key:'symbol',label:'symbol'}, {key:'side',label:'side'},
      {key:'qty',label:'qty',render:v=>fmtNum(v,6)}, {key:'price',label:'price',render:v=>fmtNum(v,6)},
